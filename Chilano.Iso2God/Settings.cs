...
public class Settings : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.cbDeleteIso = new System.Windows.Forms.CheckBox();
        ...
        this.groupBox2.Controls.Add(this.cbDeleteIso);
        ...
        this.cbTitleDirectory.Location = new System.Drawing.Point(9, 131);
        ...
        this.cbAutoBrowse.Location = new System.Drawing.Point(9, 108);
        ...
        // cbDeleteIso
        // 
        this.cbDeleteIso.AutoSize = true;
        this.cbDeleteIso.Font = new System.Drawing.Font("Segoe UI", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        this.cbDeleteIso.Location = new System.Drawing.Point(9, 13);
        this.cbDeleteIso.Name = "cbDeleteIso";
        this.cbDeleteIso.Size = new System.Drawing.Size(168, 17);
        this.cbDeleteIso.TabIndex = 8;
        this.cbDeleteIso.Text = "Delete ISO after completion";
        this.cbDeleteIso.UseVisualStyleBackColor = true;
        // 
        // cmbPadding
        // 
        ...
        this.cmbPadding.Items.AddRange(new object[] {
            ...
            "Partial",
            "Remove All"});
        this.cmbPadding.Location = new System.Drawing.Point(65, 154);
        this.cmbPadding.Name = "cmbPadding";
        this.cmbPadding.Size = new System.Drawing.Size(146, 23);
        ...
        this.cbAutoRename.Location = new System.Drawing.Point(9, 83);
        ...
        this.cbAlwaysSave.Location = new System.Drawing.Point(9, 36);
        ...
        this.cbRebuildCheck.Location = new System.Drawing.Point(9, 59);
    ...
    private void loadSettings()
    {
        try
        {
            ...
            cbDeleteIso.Checked = (bool)Properties.Settings.Default["DeleteIsoAfterCompletion"];
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
        ...
        // Save settings including the Delete ISO checkbox state
        ...
        Properties.Settings.Default["DeleteIsoAfterCompletion"] = cbDeleteIso.Checked; // Store checkbox state
        Properties.Settings.Default.Save();

        // Trigger any post-save actions, such as updating space
    ...
    // After processing (e.g., in a ProcessIso method), delete the ISO if the checkbox is checked
    private void ProcessIso(string isoFilePath)
    {
        try
        {
            // existing processing logic
            bool processingSuccessful = PerformIsoConversion(isoFilePath);  // Replace this with actual process logic

            // Check if processing is successful and if the user wants to delete the ISO
            if (processingSuccessful && cbDeleteIso.Checked)
            {
                DeleteIso(isoFilePath);  // Call your delete method
            }
        }
        catch (Exception ex)
        {
            // Handle processing errors
            MessageBox.Show("An error occurred during ISO processing: " + ex.Message);
        }
    }

    // Dummy method representing the actual ISO conversion logic
    private bool PerformIsoConversion(string isoFilePath)
    {
        // ISO conversion logic goes here
        // Return true if the process is successful, otherwise false
        return true;  // This is just a placeholder
    }

    // Method to delete ISO file
    private void DeleteIso(string isoFilePath)
    {
        try
        {
            if (File.Exists(isoFilePath))
            {
                ...
                MessageBox.Show("ISO file deleted successfully.");
            }
            else
            {
        ...
        {
            MessageBox.Show("An error occurred while deleting the ISO file: " + ex.Message);
        }
    }
}
